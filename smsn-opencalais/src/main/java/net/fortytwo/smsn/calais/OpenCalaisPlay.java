package net.fortytwo.smsn.calais;
...
public class OpenCalaisPlay {
    public static final String API_KEY = "net.fortytwo.smsn.calais.apiKey";
    ...
    private static void play() throws Exception {
        SemanticSynchrony.getConfiguration().load(new FileInputStream("/tmp/opencalais-play.props"));

        String apiKey = SemanticSynchrony.getConfiguration().getString(API_KEY);
