...
import net.fortytwo.smsn.speech.Speaker;
...
public class P5Gestures {
    ...
    private class DebugSink implements Sink<OSCMessage> {
        @Override
        public void accept(OSCMessage message) throws RippleException {
            StringBuilder sb = new StringBuilder();
    ...
    private class RealtimeSink implements Sink<OSCMessage> {
        ...
        @Override
        public void accept(final OSCMessage message) throws RippleException {
            int i = 0;
            for (Object a : message.getArguments()) {
    ...
    private class RedirectableSink<T> implements Sink<T> {
        ...
        @Override
        public void accept(T t) throws RippleException {
            downstreamSink.accept(t);
        }
    }
}
