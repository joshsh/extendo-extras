package net.fortytwo.smsn.droidspeak;
...
public class Droidspeak extends JFrame {
    ...
    public Droidspeak() throws IOException, LineUnavailableException {//constructor
        ...
        //speak(Droidspeak.class.getResourceAsStream("ok-natural.osc"));
        speak(Droidspeak.class.getResourceAsStream("ok-natural-high-short.osc"));
        //speak(Droidspeak.class.getResourceAsStream("ok-natural-higher.osc"));
